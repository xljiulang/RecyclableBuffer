...
namespace RecyclableBuffer
{
    ...
    sealed class RentedBuffer : IDisposable
    {
        ...
        public RentedBuffer(ArrayPool<byte> pool, int minimumLength)
        {
            this._pool = pool;
        ...
        public void Advance(int count)
        {
            ...
            static void Throw()
            {
                throw new ArgumentOutOfRangeException(nameof(count), "Advance count exceeds the available space in the buffer.");
            }
        }
