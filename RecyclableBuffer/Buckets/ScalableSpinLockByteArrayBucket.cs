...
namespace RecyclableBuffer.Buckets
{
    ...
    /// </summary>
    public sealed class ScalableSpinLockByteArrayBucket : ByteArrayBucket
    {
        /// <summary>
        /// 当前桶中可用缓冲区的索引。
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <see cref="ScalableSpinLockByteArrayBucket"/> 实例。
        /// </summary>
        /// <param name="arrayLength">每个数组的长度。</param>
        public ScalableSpinLockByteArrayBucket(int arrayLength)
            : base(arrayLength)
        {
        }
